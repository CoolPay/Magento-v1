...
class Coolpay_Payment_Block_Info_Coolpay extends Mage_Payment_Block_Info {
    protected function _construct() {
        parent::_construct();
        $this->setTemplate('coolpaypayment/info/default.phtml');
    }

    /**
     * Get CoolPay info HTML
     *
     * @return string
     */
    public function getCoolpayInfoHtml() {
        $res = "";
            ...
            if (is_array($row)) {
                if ($row['qpstat'] == 20000) {
                    ...
                    if ($row['qpstat'] == 20000) {
                        ...
                        $cardÍmagePath = sprintf('images/coolpaypayment/cards/%s.png', $row['cardtype']);
