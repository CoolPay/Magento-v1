...
class Coolpay_Payment_Model_Payment extends Mage_Payment_Model_Method_Abstract {
    ...
    public function getSession() {
        return Mage::getSingleton('coolpaypayment/session');
    }
    ...
    public function createFormBlock($name) {
        $block = $this->getLayout()
            ->createBlock('coolpaypayment/payment_form', $name)
            ->setMethod('coolpaypayment_payment')
            ->setPayment($this->getPayment())
            ->setTemplate('coolpaypayment/payment/form.phtml');

        return $block;
    }

    /*validate the currency code is avaialable to use for Coolpay or not*/
